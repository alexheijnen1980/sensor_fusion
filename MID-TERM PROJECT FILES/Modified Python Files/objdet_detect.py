...
def detect_objects(input_bev_maps, model, configs):
    ...
    with torch.no_grad():  
        ...
        if 'darknet' in configs.arch:
            ...
            # It looks like the detections are included in the following position in the dictionary
            detections = detections[0][1].tolist()  # only first batch
    ...
    if detections:
        ...
        for detection in detections:
            ...
            ### I did not perform this step as tools.project_detections_into_bev would then perform the reverse conversion.
            ### Instead, I commented out the reverse conversion in tools.project_detections_into_bev.
