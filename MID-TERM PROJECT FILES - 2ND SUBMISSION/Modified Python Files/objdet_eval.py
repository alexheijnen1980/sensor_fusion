    ...
    for label, valid in zip(labels, labels_valid):
        ...
        if valid: # exclude all labels from statistics which are not considered valid
            ...
            for detection in detections:
                ...
                fl_detection, rl_detection, rr_detection, fr_detection = tools.compute_box_corners(x, y, w, l, yaw)
                ...
                if iou > min_iou:
                    matches_lab_det.append([iou, float(dist_x), float(dist_y), float(dist_z)])
